...
type AuthRequest struct {
	...
	Provider      string                 `protobuf:"bytes,1,opt,name=provider,proto3" json:"provider,omitempty"` // aws or azure
...
func (x *AuthRequest) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
type AuthResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Json          string                 `protobuf:"bytes,1,opt,name=json,proto3" json:"json,omitempty"` // serialized credentials
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AuthResponse) GetJson() string {
	if x != nil {
		return x.Json
	}
	return ""
...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\x04json\x18\x01 \x01(\tR\x04json2C\n" +
	"\vAuthService\x124\n" +
	"\vRequestAuth\x12\x11.auth.AuthRequest\x1a\x12.auth.AuthResponseB\x0fZ\rsidecar/protob\x06proto3"
...
var file_proto_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthService.RequestAuth:input_type -> auth.AuthRequest
	1, // 1: auth.AuthService.RequestAuth:output_type -> auth.AuthResponse
